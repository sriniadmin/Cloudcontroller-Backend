...
var {createUuid,textToSpeech,imageUpload,validateModels, getImages, reportUpload, getLabReport, createLabReport, getReport, updateImageUpload, getLabReportById, download}=require("../../old_code_refactor/internalUser")
 ...
 */
    router.get("/dowload", download,apiFinalProcess)
